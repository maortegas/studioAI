            ...
            >
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg">{stageNames[stage.name] || stage.name}</h3>
                    <span
                      className={`inline-block mt-1 px-2 py-0.5 text-xs rounded-full font-medium ${
                        stage.status === 'done' ? 'bg-green-200 text-green-800' :
                ...
                <div className="text-right">
                  <div className="text-2xl font-bold text-gray-900">{Math.round(stage.completion)}%</div>
